...
su -l $_REMOTE_USER -c "pwsh -Command Install-Module -Force -Name Terminal-Icons -Repository PSGallery -NoProfile"
su -l $_REMOTE_USER -c "pwsh -Command Install-Module -Force -Name z -Repository PSGallery -NoProfile"
