...
su -l $_REMOTE_USER -c "curl -L -o $_REMOTE_USER_HOME/.oh-my-posh/themes/powerlevel10k.omp.json https://raw.githubusercontent.com/robinmordasiewicz/dotfiles/main/powerlevel10k.omp.json"
